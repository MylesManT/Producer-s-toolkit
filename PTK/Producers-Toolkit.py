# ------------------------------------------------------------
# Producers-Toolkit_v0.20.4f-release.py
# ------------------------------------------------------------
# Version: v0.20.4f-release
#
# Requirements:
#      Python 3.12+
#      PyQt6 (core)
...
class ProducersToolkit(QMainWindow):
    """
    Main application window for Producer's Toolkit v0.20.4f-release.
    """

    def __init__(self):
        super().__init__()
        self.setWindowTitle("Producer's Toolkit v0.20.4f-release")
                ...
                for r, row in enumerate(data):
                    if r > 0:  # Skip header
                        if row[0].startswith("LUNCH"):
                            ...
                            ts.add("BACKGROUND", (0, r), (-1, r), colors.HexColor("#a64d79"))
                            ts.add("TEXTCOLOR", (0, r), (-1, r), colors.white)
                            ts.add("SPAN", (0, r), (-1, r))
                            ts.add("TOPPADDING", (0, r), (-1, r), 10)
                            ts.add("BOTTOMPADDING", (0, r), (-1, r), 10)
